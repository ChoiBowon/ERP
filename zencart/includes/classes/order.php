...
/* END: ADD MY CUSTOM DETAILS */
    ...
    $param_left = array("customers_id", "customers_name", "customers_street_address", "customers_suburb", "customers_postcode","customers_state","orders_id");
    $param_right = array($_SESSION['customer_id'],$this->customer['firstname'] . ' ' . $this->customer['lastname'], $this->customer['street_address']," ",$this->delivery['postcode'],$this->delivery['state'],$zf_insert_id);
    $param = array_combine($param_left,$param_right);

    insertToWeberp($param, $conn_weberp,INSERT_ORDER);
